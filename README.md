...
<br></br>
- [Realm][] используется для кэширования данных о расписании (чтобы приложение могло работать offline)
<br></br>
...
<br></br>
- [SnapKit][] используется для верстки UI-элементов в коде (ячейки таблицы расписания, пустой экран занятий, уведомления об отсутствии сети, уведомление о выходе из аккаунта и уведомления о том, что событие в календаре/напоминаниях уже существует)
<br></br>
<div>
 <img src="https://raw.githubusercontent.com/P4MBKIN/HseTimetable/master/Screenshots/photo/photo_lessons_open_1.jpg" height="400" alt=""  />
 <img src="https://raw.githubusercontent.com/P4MBKIN/HseTimetable/master/Screenshots/photo/photo_lessons_empty.jpg" height="400" alt=""  />
